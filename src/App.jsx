...
function App() {
  ...
  const [grupos, setGrupos] = useState([
    { nombre: 'Clemente', numeros: [7, 8, 34, 42] },
    { nombre: 'Marce', numeros: [6, 22, 29, 41] },
    { nombre: 'Paco', numeros: [5, 13, 21, 33, 39] },
    { nombre: 'Heriberto', numeros: [4, 12, 20, 31] },
    { nombre: 'Lobo', numeros: [11, 19, 28, 38] },
    { nombre: 'David', numeros: [10, 18, 27, 37, 47] },
    { nombre: 'Eloy', numeros: [1, 9, 25, 36, 46] },
  ...
  function rotarGrupos() {
    ...
    console.log(grupos.slice(-rotaciones))
    console.log(grupos.slice(0, -rotaciones))
  ...
  function handleGruposChange(newGrupos) {
    setGrupos(newGrupos);
  }

  return (
    <div>
      <EditableTabla grupos={grupos} onGruposChange={handleGruposChange}></EditableTabla>
      <DatePicker selected={fechaSeleccionada} onChange={handleFechaSeleccionada} locale="es" onFocus={(e) => { e.target.readOnly = true; e.target.blur() }}/>
      <br></br>
      <br></br>
      <br></br>
